...
export default function MyMenu({ menuName, detail }: { menuName: string; detail?: string }) {
  return (
    <button className="flex py-3 px-4 justify-between items-center w-full border-b border-gray-50">
